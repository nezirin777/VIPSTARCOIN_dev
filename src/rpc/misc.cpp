...
static RPCHelpMan validateaddress()
{
    return RPCHelpMan{"validateaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The VIPSTARCOIN address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
    ...
    return RPCHelpMan{"getaddressdeltas",
            "\nReturns all changes for an address (requires addressindex to be enabled).\n",
            {
                {"argument", RPCArg::Type::OBJ, RPCArg::Optional::NO, "Json object",
                    {
                        {"addresses", RPCArg::Type::ARR, RPCArg::Optional::NO, "The VIPSTARCOIN addresses",
                            {
                                {"address", RPCArg::Type::STR, RPCArg::Optional::OMITTED, "The VIPSTARCOIN address"},
                            }
                        },
...
RPCHelpMan listconf()
{
    return RPCHelpMan{"listconf",
                "\nReturns the current options that vipstarcoind was started with.\n",
                {},
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
using wallet::DescribeWalletAddress;
bool getAddressToPubKey(const wallet::CWallet& wallet, std::string addr, std::string& pubkey)
{
...
static RPCHelpMan verifymessage()
{
    return RPCHelpMan{"verifymessage",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The VIPSTARCOIN address to use for the signature."},
