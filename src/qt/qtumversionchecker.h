#ifndef VIPSVERSIONCHECKER_H
#define VIPSVERSIONCHECKER_H

#include <QObject>

#define VIPS_RELEASES "https://github.com/vipstarcoinproject/vipstarcoin/releases"
